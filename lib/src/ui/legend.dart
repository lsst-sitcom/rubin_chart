...
typedef LegendSelectionCallback = void Function({required Series series, required BuildContext context});
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return InkWell(
              onTap: () {
                print("tapped $index");
                selectionCallback?.call(series: rows[index].series, context: context);
              },
              child: rows[index],
            );
          },
